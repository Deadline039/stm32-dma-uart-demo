...
//  <o USART6_HWCONTROL> 硬件流控
//      <UART_HWCONTROL_NONE=>无
//      <UART_HWCONTROL_RTS=>RTS
//      <UART_HWCONTROL_CTS=>CTS
//      <UART_HWCONTROL_RTS_CTS=>RTS+CTS
#define USART6_HWCONTROL UART_HWCONTROL_NONE
...
//      <DMA_PRIORITY_HIGH=>高
//      <DMA_PRIORITY_VERY_HIGH=>非常高
#define USART6_DMA_TX_PRIORITY   DMA_PRIORITY_LOW
//  <o> 串口6 DMA发送中断抢占优先级
#define USART6_DMA_TX_IT_PREEMPT 2
//  <o> 串口6 DMA发送中断子优先级
#define USART6_DMA_TX_IT_SUB     3
...
//      <DMA_PRIORITY_HIGH=>高
//      <DMA_PRIORITY_VERY_HIGH=>非常高
#define USART6_DMA_RX_PRIORITY   DMA_PRIORITY_LOW
//  <o> 串口6 DMA接收中断抢占优先级
#define USART6_DMA_RX_IT_PREEMPT 1
//  <o> 串口6 DMA接收中断子优先级
#define USART6_DMA_RX_IT_SUB     2
