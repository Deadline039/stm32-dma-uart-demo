...
void uart5_init(uint32_t baud_rate) {
    ...
    extern void uart5_dmatx_init(void);
    uart5_dmatx_init();
#endif /* UART5_USE_DMA_TX == 1 */

#if (UART5_USE_DMA_RX == 1)
    extern void uart5_dmarx_init(void);
    uart5_dmarx_init();
...
void usart6_init(uint32_t baud_rate) {
    ...
    usart6_handle.Init.HwFlowCtl = USART6_HWCONTROL;
    ...
    extern void usart6_dmatx_init(void);
    usart6_dmatx_init();
#endif /* USART6_USE_DMA_TX == 1 */

#if (USART6_USE_DMA_RX == 1)
    extern void usart6_dmarx_init(void);
    usart6_dmarx_init();
...
void uart7_init(uint32_t baud_rate) {
    ...
    extern void uart7_dmatx_init(void);
    uart7_dmatx_init();
#endif /* UART7_USE_DMA_TX == 1 */

#if (UART7_USE_DMA_RX == 1)
    extern void uart7_dmarx_init(void);
    uart7_dmarx_init();
...
void uart8_init(uint32_t baud_rate) {
    ...
    extern void uart8_dmatx_init(void);
    uart8_dmatx_init();
#endif /* UART8_USE_DMA_TX == 1 */

#if (UART8_USE_DMA_RX == 1)
    extern void uart8_dmarx_init(void);
    uart8_dmarx_init();
